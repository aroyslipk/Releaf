...
<head>
    ...
    <style>
        ...
        .task-card.funlab .enter-button:hover {
            color: #7c3aed;
        }
    ...
    <main class="main-content">
        ...
        <div class="tasks-container">
            <div class="cards-grid">
                <!-- Greenverse Management Card -->
                <div class="task-card" onclick="window.location.href='/admin/greenverse/tasks'">
                    <div class="admin-badge">Admin Panel</div>
                    <div class="task-icon">⚙️</div>
                    <h1 class="task-title">Greenverse Task Management</h1>
                ...
                <!-- FunLab Management Card -->
                <div class="task-card funlab" onclick="window.location.href='/admin/funlab'">
                    <div class="admin-badge">Admin Panel</div>
                    <div class="task-icon">🧪</div>
                    <h1 class="task-title">FunLab Task Management</h1>
                    <p class="task-subtitle">
                        Manage fun and creative eco-tasks! Create, edit, and monitor 
                        FunLab task submissions with flexible proof types.
                    </p>
                    ...
                    <div class="task-stats">
                        ...
                        <div class="stat-item">
                            ...
                            <span class="stat-label">Proof Types</span>
                        </div>
                        <div class="stat-item">
