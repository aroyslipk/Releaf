...
public interface UserTaskRepository extends JpaRepository<UserTask, Long> {
    ...
    @Cacheable("userTasks")
    @Query("SELECT ut FROM UserTask ut WHERE ut.user.id = :userId AND ut.task.id = :taskId ORDER BY ut.submittedAt DESC")
    List<UserTask> findByUserIdAndTaskId(@Param("userId") Long userId, @Param("taskId") Long taskId);
