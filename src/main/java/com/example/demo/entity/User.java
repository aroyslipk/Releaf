...
public class User {
    ...
    @Column(name = "last_submitted_topic")
    private String lastSubmittedTopic;
    ...
    public String getLastSubmittedTopic() {
        return lastSubmittedTopic;
    }

    public void setLastSubmittedTopic(String lastSubmittedTopic) {
        this.lastSubmittedTopic = lastSubmittedTopic;
    }

    public String getLastSubmittedDifficulty() {
        return lastSubmittedDifficulty;
    }
